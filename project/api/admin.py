...
admin.site.register(CountryLevelLayer)
admin.site.register(RegionalLevelLayer)
admin.site.register(IndependentLevelLayer)
admin.site.register(GroupLevelLayer)
